...
public class Form_Fornecedores extends javax.swing.JPanel {
    ...
    public Form_Fornecedores() {
        initComponents();
        card1.setData(new Model_Card(new ImageIcon(getClass().getResource("/view/Icons/network-pos.png")), "Total de Fornecedores", "5300", "Increased by 60%"));
        card2.setData(new Model_Card(new ImageIcon(getClass().getResource("/view/Icons/currency-usd.png")), "Total de lolas", "$35000", "Increased by 25%"));
