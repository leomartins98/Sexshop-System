...
public class Form_Clientes extends javax.swing.JPanel {
    ...
    public Form_Clientes() {
        initComponents();
        card1.setData(new Model_Card(new ImageIcon(getClass().getResource("/view/Icons/network-pos.png")), "Total de Clientes", "5300", "Increased by 60%"));
        card2.setData(new Model_Card(new ImageIcon(getClass().getResource("/view/Icons/currency-usd.png")), "Total de sla", "$35000", "Increased by 25%"));
