...
public class Form_Home extends javax.swing.JPanel {
    ...
    public Form_Home() {
        initComponents();
        card1.setData(new Model_Card(new ImageIcon(getClass().getResource("/view/Icons/network-pos.png")), "Total de Colaboradores", "200", "Increased by 60%"));
        card2.setData(new Model_Card(new ImageIcon(getClass().getResource("/view/Icons/currency-usd.png")), "Total de PIKA", "$15000", "Increased by 25%"));
...
//          add row table
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nome", "Email", "Cargo", "Data_Cadastro"
            }
        ));
