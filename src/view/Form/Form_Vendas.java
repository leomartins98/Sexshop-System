...
public class Form_Vendas extends javax.swing.JPanel {
    ...
    public Form_Vendas() {
        initComponents();
        card1.setData(new Model_Card(new ImageIcon(getClass().getResource("/view/Icons/network-pos.png")), "Total de Vendas", "12000", "Increased by 60%"));
        card2.setData(new Model_Card(new ImageIcon(getClass().getResource("/view/Icons/currency-usd.png")), "Total arrecadado", "$325000", "Increased by 25%"));
